...
namespace Ink.UnityIntegration
{
    ...
    public class InkFile
    {
        ...
        public List<string> recursiveIncludeErrorPaths = new();
        ...
        public List<DefaultAsset> masterInkAssets = new();
        ...
        public List<string> localIncludePaths = new();
        ...
        public List<InkFile> includesInkFiles
        {
            get
            {
                List<InkFile> _includesInkFiles = new();
