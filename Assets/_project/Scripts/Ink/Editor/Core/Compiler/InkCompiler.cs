...
namespace Ink.UnityIntegration
{
	...
	public class InkCompiler : ScriptableObject {
        ...
        public static void CompileInk(InkFile[] inkFiles, bool immediate, Action onComplete = null)
        {
            ...
            StringBuilder filesCompiledLog = new("Files compiled:");
        ...
        {
            List<InkFile> masterInkFiles = new();
        ...
        private static readonly List<Action> onCompleteActions = new();
        ...
        [SerializeField]
        private List<string> pendingCompilationStack = new();

        // The state of files currently being compiled.
        [SerializeField]
        private List<InkCompiler.CompilationStackItem> compilationStack = new();
        #endregion
        ...
        private class CompilationStackItem
        {
            ...
            public List<InkCompilerLog> logOutput = new();
            public List<string> unhandledErrorOutput = new();
        ...
        private static void CompileInkInternal(InkFile inkFile, bool immediate)
        {
            ...
            CompilationStackItem pendingFile = new()
            {
        ...
        private static void OnCompleteCompilationStack()
        {
            ...
            List<CompilationStackItem> compilationStack = new(instance.compilationStack);
