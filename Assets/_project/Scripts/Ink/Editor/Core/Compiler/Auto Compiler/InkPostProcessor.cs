...
namespace Ink.UnityIntegration
{
    ...
    public class InkPostProcessor : AssetPostprocessor
    {
        ...
        private static readonly List<string> queuedMovedInkFileAssets = new();
        ...
        private static void OnDeleteAssets(string[] deletedAssets)
        {
            ...
            List<InkFile> masterFilesAffected = new();
        ...
        private static void OnMoveAssets(string[] movedAssets)
        {
            ...
            List<string> validMovedAssets = new();
            ...
            {
                List<InkFile> filesToCompile = new();
        ...
        {
            List<string> importedInkAssets = new();
